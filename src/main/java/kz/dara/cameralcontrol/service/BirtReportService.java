...
public class BirtReportService implements ApplicationContextAware, DisposableBean {
    ...
    public void generateMainReport(String reportName, OutputType output, Object id, String lang, HttpServletResponse response, HttpServletRequest request) {
        switch (output) {
        case HTML:
     ...
     */
    @SuppressWarnings("unchecked")
    private void generateHTMLReport(IReportRunnable report, Object id, String lang, HttpServletResponse response, HttpServletRequest request) {
     ...
     */
    @SuppressWarnings("unchecked")
    private void generatePDFReport(IReportRunnable report, Object id, String lang, HttpServletResponse response, HttpServletRequest request) {
        IRunAndRenderTask runAndRenderTask = birtEngine.createRunAndRenderTask(report);
     ...
     */
    @SuppressWarnings("unchecked")
    private void generateDOCXReport(IReportRunnable report, Object id, String lang, HttpServletResponse response, HttpServletRequest request) {
        IRunAndRenderTask runAndRenderTask = birtEngine.createRunAndRenderTask(report);
     ...
     */
    @SuppressWarnings("unchecked")
    private void generateXLSXReport(IReportRunnable report, Object id, String lang, HttpServletResponse response, HttpServletRequest request) {
        IRunAndRenderTask runAndRenderTask = birtEngine.createRunAndRenderTask(report);
     ...
     */
    @SuppressWarnings("unchecked")
    private void generateReport(IReportRunnable report, OutputType output, Object id, String lang, HttpServletResponse response, HttpServletRequest request) {
        IRunAndRenderTask runAndRenderTask = birtEngine.createRunAndRenderTask(report);
